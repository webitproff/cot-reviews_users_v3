 ...
 * Plugin Info
 */
$L['info_name'] = 'Отзывы о пользователе';
$L['info_desc'] = 'Управление отзывами пользователей о других пользователях. Публикуются на странице пользователя. можно выводить на главной.';
$L['info_notes'] = 'Плагин значительно переработан и может быть не совместим со старыми сборками сайтов на Cotonti.';
...
$L['reviews_users_details'] = 'Отзывы обо мне';
$L['reviews_users_details_desc'] = 'Отзывы других пользователей и участников сообщества об этом пользователе';
...
$L['reviews_last_index'] = 'Последние отзывы о пользователях и продавцах на сайте';

$L['reviews_users_avr_reviews'] = 'Средняя оценка';