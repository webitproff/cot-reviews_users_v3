 ...
 * @copyright Copyright (c) 202 iemand
 * @license BSD
 */
...
if ($a == 'add') {
    ...
    if (!cot_error_found() && $ritem['item_touserid'] != $ritem['item_userid']) {
        ...
        $subject = $L['reviews_new_review'] . ": " . htmlspecialchars($ritem['item_title']);
        $body = $L['reviews_new_review_body'] . "\n\n";
        $body .= $L['reviews_title'] . ": " . htmlspecialchars($ritem['item_title']) . "\n";
        $body .= $L['reviews_text'] . ": " . htmlspecialchars($ritem['item_text']) . "\n";
    ...
    if (!cot_error_found()) {
        ...
        $subject = $L['reviews_updated_review'] . ": " . htmlspecialchars($ritem['item_title']);
